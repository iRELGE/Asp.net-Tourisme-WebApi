import { BestActivitiesModule } from './../Models/best-activities/best-activities.module';
...
export class SliderComponent implements OnInit {
  ...
  constructor(private sanitizer: DomSanitizer, private bestA: BestActivitiesService) {
  }
  betsA: BestActivitiesModule[] = []
  ur = "http://localhost:51473/Image/"



  ngOnInit() {
    this.bestActiviView()
    this.imageUrls = ['assets/img/1.PNG', 'assets/img/&&.PNG', 'assets/img/002-3.jpg'];
  ...
  bestActiviView() {
    this.bestA.getAllActivities().subscribe((res: BestActivitiesModule[]) => {
      this.betsA = res;
